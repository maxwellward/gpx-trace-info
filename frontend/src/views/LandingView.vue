<template>
  <div>
    <div class="items-center flex flex-col mt-16">
      ...
      <h1 class="text-muted-foreground tracking-widest font-light uppercase my-6">
        GPX Statistics
      </h1>
      <h2 class="text-3xl font-semibold w-2/3 text-center">
        View and manage your OpenStreetMap GPX traces, all from one place.
      </h2>
      <Button
        class="mt-8"
        :class="authStore.isAuthenticated ? 'w-36' : 'w-56'"
...
const cards = [
  {
    ...
    icon: h(ChartLine),
    description:
      'Beautiful charts showing off your total GPX traces, kilometers traced, and GPS points over your specified time period.',
  },
  {
  ...
  },
  {
    ...
    icon: h(WandSparkles),
    description:
      "All of what you want, none of what you don't. Looking for a new feature or found a bug? We're open source on GitHub.",
  },
]
</script>
