<template>
	<div>
		<div class="flex items-center justify-between">
			<h1 class="text-text-primary font-extrabold tracking-wider text-xl sm:text-2xl">GPX Statistics</h1>
			<div class="space-x-2 flex">
				...
				<Avatar>
					<AvatarImage src="https://avatars.githubusercontent.com/u/13861522?v=4" alt="@maxwellward" />
