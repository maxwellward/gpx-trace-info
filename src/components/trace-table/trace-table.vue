<template>
	<div class="relative w-full max-w-sm items-center mb-2">
	...
	<div class="mt-1 flex-1 text-sm text-muted-foreground"
		...
		<p>{{ table.getFilteredSelectedRowModel().rows.length }} of {{ table.getFilteredRowModel().rows.length }} {{
			table.getFilteredRowModel().rows.length > 1 ? 'rows' : 'row' }} selected.</p>
	</div>
